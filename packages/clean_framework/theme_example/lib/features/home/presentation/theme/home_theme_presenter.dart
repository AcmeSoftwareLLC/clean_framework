...
class HomeThemePresenter
    extends
        Presenter<HomeThemeViewModel, HomeThemeDomainToUIModel, HomeUseCase> {
  HomeThemePresenter({required super.builder, super.key})
    : super(provider: homeUseCaseProvider);

  @override
  HomeThemeViewModel createViewModel(
    HomeUseCase useCase,
    HomeThemeDomainToUIModel domainModel,
  ) {
    return HomeThemeViewModel(appTheme: domainModel.appTheme);
  }
