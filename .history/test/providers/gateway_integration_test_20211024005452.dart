...
class TestBridgeGateway extends BridgeGateway<TestOutput, TestOutput, TestSuccessInput>{
  TestBridgeGateway({
    required UseCase subscriberUseCase,
    required UseCase publisherUseCase,
  }):super(subscriberUseCase: subscriberUseCase, publisherUseCase: publisherUseCase);
  @override
  TestSuccessInput onResponse(TestOutput output) => TestSuccessInput(output.foo);
}
