...
void main() {
  test('All providers', () async {
    ...
    final externalInterface = TestInterface([gateWay]);

    final provider = UseCaseProvider((_) => useCase);
    final gatewayProvider = GatewayProvider((_) => );
...
class TestInterface extends ExternalInterface {
  TestInterface(List<GatewayConnection<Gateway>> connections) : super(connections);
