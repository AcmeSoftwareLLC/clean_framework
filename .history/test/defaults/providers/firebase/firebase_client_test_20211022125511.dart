...
void main() {
  ...
  final fireStore = FirebaseClient(mock);
  ...
  group('FirebaseClient tests:: ', () {
    test('write; without id', () async {
      ...
      final id = await fireStore.write(
        path: path,
        model: UserModel(name: 'Sarbagya Dhaubanjar'),
      );
    ...
    test('read', () async {
      ...
      final data = await fireStore.read(
        path: path,
        id: id,
    ...
    test('readAll', () async {
      ...
      final data = await fireStore.readAll(
        path: path,
        converter: (rawData) => UserModel.fromJson(rawData),
        query: (ref) => ref,
      );
