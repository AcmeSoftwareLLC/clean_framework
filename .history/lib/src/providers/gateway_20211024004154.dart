...
abstract class DomainGateway<SUBSCRIBER_OUTPUT extends Output,
  ...
  DomainGateway(
    ...
    _subscriberUseCase.subscribe(
          ...
          (SUBSCRIBER_OUTPUT output) async { 
            _processSubscription(subscribeTo());
          }
        );
    ...
    Future<Either<FailureInput, SUBSCRIBER_INPUT>> _processSubscription(PUBLISHER_OUTPUT destinationOutput) async {
      final publisher = _provider.getUseCaseFromContext(context);
    }

    PUBLISHER_OUTPUT subscribeTo();
