...
abstract class DomainGateway<ORIGIN_OUTPUT extends Output,
  ...
  DomainGateway(
    ...
    _subscriberUseCase.subscribe(
          ORIGIN_OUTPUT,
          (ORIGIN_OUTPUT output) async => _processSubscription(forwardToPublisher(output)),
        );
    ...
    Future<Either<FailureInput, DESTINATION_OUTPUT>> _processSubscription(R request) async {

    }
    DESTINATION_OUTPUT forwardToPublisher(ORIGIN_OUTPUT originOutput);
}
