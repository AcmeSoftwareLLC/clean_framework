...
class FirebaseClient {
  ...
  void createQuery<T>(String path, SnapshotQuery<T> query) {
    if (_queryRef == null) {
      var ref = _fireStore.collection(path);
      //ref.orderBy(FieldPath.documentId);
      _queryRef = query(ref as CollectionReference<T>) as CollectionReference<T>;
