...
- [example_rest](https://github.com/AcmeSoftwareLLC/clean_framework_examples/tree/main/example_rest) (with PokéAPI REST v2)
- [example_graphql](https://github.com/AcmeSoftwareLLC/clean_framework_examples/tree/main/example_graphql) (with PokéAPI GraphQL v1 beta, using the `clean_framework_graphql` package)
