...
For this example, we'll be using the [PokéAPI](https://pokeapi.co/).

### The Feature Requirements

Once you've set up your feature folder, you might be eager to dive into adding Flutter Widgets. The great thing about this framework is its flexibility; you can start crafting components without needing to worry about dependencies like databases, services, or caches. That's because these concerns are handled by other layers.
...
#### in lib/features/home/presentation/home_view_model.dart
```dart
...
#### in lib/features/home/presentation/home_presenter.dart
```dart
...
#### in lib/features/home/presentation/home_ui.dart
```dart
...
Congratulations, you're finished implementing the Presentation layer! The app should now run perfectly fine using the static data we gave to our view model.
...
Now that our Presentation layer is complete, we're ready to move on to the Domain layer and start adding logic to our app in the next section.